-- A timeline possui FK imediata para documentos_tecnicos. O evento de criacao
-- nao pode ser inserido pelo trigger BEFORE, antes de a linha pai existir.
...
-- Uma tentativa que falhou ainda ocupa (relatorio_id, numero_revisao). Reusar
-- a linha falha preserva a numeracao R00/Rxx, o codigo de validacao e o rastro
-- de auditoria, alem de sobrescrever com seguranca o upload orfao no retry.
