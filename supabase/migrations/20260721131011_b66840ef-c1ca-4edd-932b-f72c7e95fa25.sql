...
BEGIN
  ...
  RETURN jsonb_build_object('itens', _total, 'plano_id', _plano_id, 'prompt_codigo', p_prompt_codigo, 'modelo_ia', p_modelo_ia);
END;
$$;

-- Contexto também precisa aceitar 'pronta_para_aprovacao'
