-- A cancelled assessment must no longer reserve the completed-file hash.
-- This preserves duplicate protection for active assessments while allowing a
-- technically invalid import to be replaced using the original source file.
...
-- Reconcile assessments cancelled before this trigger was installed.
