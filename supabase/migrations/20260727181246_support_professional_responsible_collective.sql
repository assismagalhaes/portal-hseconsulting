-- A revisão coletiva pode ser assinada por um perfil interno ou por um
-- profissional ativo do cadastro operacional. O UUID selecionado permanece no
-- campo legado responsavel_tecnico_id; a origem é resolvida no snapshot.
...
BEGIN
  ...
  IF v_snap IS NULL THEN RAISE EXCEPTION 'RESPONSAVEL_TECNICO_NAO_LOCALIZADO'; END IF;
