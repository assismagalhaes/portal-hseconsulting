-- Historical raw imports intentionally have no artificial invitations and may use
-- an unpublished legacy questionnaire version. Their response/item integrity is
-- still validated before result processing.
