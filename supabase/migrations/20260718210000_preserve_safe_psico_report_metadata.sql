-- O sanitizador continua removendo nomes de respondentes em qualquer nivel,
-- mas preserva explicitamente apenas a identificacao profissional registrada
-- no snapshot aprovado da revisao tecnica. O e-mail nunca e copiado.
